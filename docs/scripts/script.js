...
function wikifyText(text) {
  ...
  // Iterate over symbols to replace
  for (const [symbolKey, symbolValue] of Object.entries(symbols)) {
    completeText = completeText.replace(new RegExp(symbolKey, 'g'), symbolValue);
  }
